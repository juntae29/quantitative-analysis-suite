...
from analyzer import run_quantitative_analysis, generate_wordcloud, set_matplotlib_font, get_font
    ...
    if st.button("Run Analysis"):
        ...
        with t3:
            if G and len(G.nodes) > 0:
                ...
                # Drawing with labels explicitly using the FontProperties object
